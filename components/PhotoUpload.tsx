      ...
      <div className="flex flex-col items-center justify-center w-full">
        ...
        >
          <div className="flex flex-col items-center justify-center pt-5 pb-6">
            <svg
              className={`w-10 h-10 mb-3 ${isDragging ? 'text-blue-500' : 'text-gray-400 dark:text-gray-500'}`}
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
            ...
            <p className="text-xs text-gray-400 dark:text-gray-500">PNG, JPG, GIF up to 10MB (multiple files supported)</p>
          </div>
          <input
            id="photo-upload"
            ref={fileInputRef}
